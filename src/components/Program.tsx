...
const PROGRAM: ProgramDay[] = [
  {
    ...
    items: [
      ...
      { time: "13:00–14:30", title: "Lunch break", detail: "Speed-friending in the second half", kind: "pause" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "12:30–14:00", title: "Lunch break & live music", detail: "Foyer · complimentary · speed-friending in the second half", kind: "social" },
