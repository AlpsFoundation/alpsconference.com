        ...
        <div className="flex-[1_1_0] flex flex-col items-center justify-end gap-4 sm:gap-5 min-h-0 pb-28">
          ...
          <div className="flex flex-row flex-nowrap items-stretch justify-center gap-1 min-[400px]:gap-2 sm:gap-4 w-full max-w-full">
            ...
            <a
              data-animate-scale
              href="#tickets"
              className="opacity-0 flex flex-1 sm:flex-initial min-w-0 items-center justify-center gap-1 sm:gap-2.5 px-2 min-[400px]:px-3 sm:px-7 py-2.5 sm:py-4 bg-primary hover:bg-primary-light text-white text-[11px] min-[400px]:text-xs sm:text-base font-semibold rounded-sm transition-all duration-300 hover:shadow-lg hover:shadow-primary/25 leading-tight"
            >
