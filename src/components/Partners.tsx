...
export default function Partners() {
  ...
  const PARTNERS = [
    { key: "academic", label: t.partners.academic, logos: PARTNER_DATA.academic },
    { key: "associations", label: t.partners.associations, logos: PARTNER_DATA.associations },
    { key: "media", label: t.partners.media, logos: PARTNER_DATA.media },
  ];
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-10 sm:space-y-12">
          {PARTNERS.map(({ key, label, logos }) => (
            <div key={key} data-fade-up className="opacity-0">
