...
export const EXPERIENCE_DAYS: ExperienceDay[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: "11:15–12:30 & 13:45–15:00", title: "Breathwork", venue: "Saal 4", personName: "Pascal Kälin" },
      { time: "12:30–14:00", title: "Live concert", venue: "Saal 2", personName: "David & Anna-Lea Wennberg" },
      { time: "16:10–16:55", title: "Sound meditation", venue: "Saal 4", personName: "Marina Vovk" },
