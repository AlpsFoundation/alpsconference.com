        ...
        sessions: [
          {
            ...
            description:
              "During the conference, her yoga session offers a chance to step out of sitting and thinking and come back into the body. Through slow movement, breathing and gentle stretching, participants can let go of stiffness and stress, give the nervous system time to settle, and return to the programme at a calmer pace.\n\nHer approach is slow and unhurried, with more attention on how a movement feels than on how it looks. No previous experience is needed, and nothing in the practice is demanding. Yoga mats will be provided. Feel free to come in what you're wearing, as long as you're comfortable sitting on the floor and moving gently, or to change into something looser if you prefer. She guides participants towards their own sensations, so they can notice what it is like to be fully present in their body while they move, and follow what they need on the day.\n\nFor the conference, Andrea will offer a quiet session of gentle movement and embodiment, designed as a space to release tension, regulate, and arrive back in the body.",
          },
        ],
