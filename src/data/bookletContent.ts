...
export const BOOKLET_NAV = [
  ...
  { id: "workshops", label: "Workshop program", printLabel: "workshop program" },
  ...
  { id: "posters", label: "Posters", printLabel: "posters" },
...
/** Swiss Psychedelic Student Network member associations, as shown in the booklet. */
export const SPSN_GROUPS = [
  { file: "probe.png", name: "PR@Be", city: "Bern" },
  { file: "parab.png", name: "PARAB", city: "Basel" },
  { file: "proof.png", name: "PROOF", city: "Fribourg" },
  { file: "proz.png", name: "PROZ", city: "Zurich" },
  { file: "napa.png", name: "NAPA", city: "Neuchâtel" },
  { file: "pala.png", name: "PALA", city: "Lausanne" },
  { file: "arp.png", name: "ARP", city: "Geneva" },
  { file: "spsn.png", name: "SPSN", city: "Switzerland" },
];
...
export const POSTERS = {
  ...
  formats: [
    "A0 — each original piece of artwork only exists once. Signed version for CHF 222.",
    "A2 — CHF 35.",
    "Postcards — CHF 5.",
  ],
  note: "Purchase at the ALPS info table. Last year’s collection is also available, alongside the rest of the ALPS merchandise in our online shop.",
  works: [
    "WIRED",
    "HELLO YOU",
    "MECHANIC FEELINGS",
